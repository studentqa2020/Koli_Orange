@Smoke 
Feature: Orange_Demo testing 

@TS_0123 @TC_002 
Scenario Outline: Successful Orange_Demo testing 
	...
	Examples: 
		|URL							|attributes			|
		|http://localhost:3000/posts	|coord				|
		|http://localhost:3000/posts	|weather			|
		|http://localhost:3000/posts	|main				|
		|http://localhost:3000/posts	|visibility			|
		|http://localhost:3000/posts	|wind				|
		|http://localhost:3000/posts	|clouds				|
		|http://localhost:3000/posts	|sys				|
